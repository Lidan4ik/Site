...
class HumenControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create human" do
    assert_difference("Human.count") do
      post humen_url, params: { human: { email: @human.email, first_name: @human.first_name, last_name: @human.last_name, phone: @human.phone, twitter: @human.twitter } }
    end
  ...
  test "should update human" do
    patch human_url(@human), params: { human: { email: @human.email, first_name: @human.first_name, last_name: @human.last_name, phone: @human.phone, twitter: @human.twitter } }
